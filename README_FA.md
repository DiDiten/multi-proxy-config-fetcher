[![Stars](https://img.shields.io/github/stars/DiDiten/multi-proxy-config-fetcher?style=flat-square)](https://github.com/DiDiten/multi-proxy-config-fetcher/stargazers)
[![Forks](https://img.shields.io/github/forks/DiDiten/multi-proxy-config-fetcher?style=flat-square)](https://github.com/DiDiten/multi-proxy-config-fetcher/network/members)
[![Issues](https://img.shields.io/github/issues/DiDiten/multi-proxy-config-fetcher?style=flat-square)](https://github.com/DiDiten/multi-proxy-config-fetcher/issues)
[![License](https://img.shields.io/github/license/DiDiten/multi-proxy-config-fetcher?style=flat-square)](https://github.com/DiDiten/multi-proxy-config-fetcher/blob/main/LICENSE)
[![Activity](https://img.shields.io/github/last-commit/DiDiten/multi-proxy-config-fetcher?style=flat-square)](https://github.com/DiDiten/multi-proxy-config-fetcher/commits)
...
```
https://raw.githubusercontent.com/DiDiten/multi-proxy-config-fetcher/refs/heads/main/configs/singbox_configs.json
```
...
### گزارش تفصیلی
📊 [مشاهده داشبورد تعاملی کامل](https://htmlpreview.github.io/?https://github.com/DiDiten/multi-proxy-config-fetcher/blob/main/assets/performance_report.html)
...
```bash
# کلون کردن مخزن
git clone https://github.com/DiDiten/multi-proxy-config-fetcher.git
